...
public class UserController {
	...
	public Status addPassenger(@RequestBody PassengerDto passengerDto) {
		try {
			...
			passenger.setPassangerName(passengerDto.getPassengerName());
			passenger.setPassangerAge(passengerDto.getPassengerAge());
	...
	public List<Passenger> viewAllPassenger(@RequestBody PassengerSearchDto passenger) {
		return passengerService.viewAllPassenger(passenger.getUserId(), passenger.getFlightId());
	}
